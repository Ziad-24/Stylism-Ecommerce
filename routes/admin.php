...
Route::group(['middleware' => 'admin' , 'prefix'=>'admin'],function(){
    ...
    Route::group(['prefix' => 'users'] , function(){
        ...
        Route::get('add' , [HandleUserController::class , 'createAdmin']) -> name('admin.user.addAdmin');
        Route::post('create' , [HandleUserController::class , 'storeAdmin']) -> name('admin.user.createAdmin');
    ...
    Route::group(['prefix' => 'products'] , function(){
        ...
        Route::post('update' , [ProductController::class , 'updateProduct']) -> name('admin.product.update');
